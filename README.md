...
.
Requirements per Term: For every concept, you must provide an original definition (2-3 sentences), a short real-world example, and a citation from a credible source
.
Referencing: You must use at least five credible industry or academic sources, such as Harvard Business Review, McKinsey, or your course textbook
.
Constraints: The final document should be 6–10 pages long
. All definitions must be in your own words; copy-pasting or using AI-generated text for the final submission will result in a grade of zer
